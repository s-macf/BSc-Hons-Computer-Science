...
//        if (testSet.equals(tempSet)){
//
//            for (Location key : watchedUndergrounds.keySet()){
//                System.out.println(key.getNumber() + ": " + watchedUndergrounds.get(key));
//            }
//
//            System.out.println("\n");
//            System.out.println("loc Score: " + currentLocationScore);
//            System.out.println("UG Score: " + unwatchedUndergroundCount);
//            System.out.println("Punish Score: " + punishScore);
//            System.out.println("Ferry Score: " + ferriesWatched.size());
//        }
