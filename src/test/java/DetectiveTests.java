...
public class DetectiveTests {
    ...
    void when_Stranded_On_Taxi_Available_Moves_Should_Be_Empty(){
        ...
        Mr_X mr_x = new Mr_X(Color.WHITE, map.getNodeByNumber(91));
...
//        // then
        Pair<Location, Ticket> playedMove =  Detective_AI.getMove(blueDetective, blueDetective.getAvailableMoves(detectives), currentRound, mr_x);
    ...
    void when_Stranded_On_Bus_Available_Moves_Should_Be_Empty(){
        ...
        Mr_X mr_x = new Mr_X(Color.WHITE, map.getNodeByNumber(22));
        detectives.add(blueDetective);
        int currentRound = 3;
